...
//        printWriter.println("DATE: " + getFormattedDate() + " RM2.Client Action: " + action + " | RequestParameters: " + requestParams + " | RM2.Server Response: " + response);
//
//        printWriter.close();
    }
...
//            {
//                fileName = dir + "\\src\\Logs\\RM2.Server\\Montreal.txt";
//            } 
//            else if (ID.equalsIgnoreCase("SHE")) 
//            {
//                fileName = dir + "\\src\\Logs\\RM2.Server\\Sherbrooke.txt";
//            } 
//            else if (ID.equalsIgnoreCase("QUE"))
//            {
//                fileName = dir + "\\src\\Logs\\RM2.Server\\Quebec.txt";
//            }
//            
//        } 
//        else 
//        {
//            fileName = dir + "\\src\\Logs\\RM2.Client\\" + ID + ".txt";
//        }
//        return fileName;
    }
