...
public class Logger {
	...
	public static void clientLog(String clientID, String action, String requestParams, String response)
			throws IOException {
...
//        printWriter.close();
	...
	public static void serverLog(String serverID, String clientID, String requestType, String requestParams,
			String serverResponse) throws IOException {

//        if (clientID.equals("null")) {
//            clientID = "Appointment Manager";
//        }
...
//                fileName = "../logs/RM3/Server/Montreal.txt";
//            } else if (ID.equalsIgnoreCase("SHE")) {
//                fileName = "../logs/RM3/Server/Sherbrooke.txt";
//            } else if (ID.equalsIgnoreCase("QUE")) {
//                fileName = "../logs/RM3/Server/Quebec.txt";
//            }
//        } else {
//            fileName = "../logs/RM3/Client/" + ID + ".txt";
//        }
//        return fileName;
		return "";
	}
