...
public class MTLServerInstance {
    ...
    public MTLServerInstance(String serverId, String[] args) throws Exception {
        this.serverID = serverId;
        serverName = Constants.APPOINTMENT_SERVER_MONTREAL;
        serverUdpPort = Constants.MONTREAL_SERVER_PORT;
        serverUrl = Constants.MTL_ADDRESS;
        try {
            MTLHealthCareImpl servant = new MTLHealthCareImpl(serverID, serverName);
    ...
    private static void listenForRequest(MTLHealthCareImpl obj, int serverUdpPort, String serverName, String serverID) {
