...
public class SHEServerInstance {
    ...
    public SHEServerInstance(String serverId, String[] args) throws Exception {
        this.serverID = serverId;
        serverName = Constants.APPOINTMENT_SERVER_SHERBROOK;
        serverUdpPort = Constants.SHERBROOKE_SERVER_PORT;
        serverUrl = Constants.SHE_ADDRESS;
        try {
            SHEHealthCareImpl servant = new SHEHealthCareImpl(serverID, serverName);
    ...
    private static void listenForRequest(SHEHealthCareImpl obj, int serverUdpPort, String serverName, String serverID) {
